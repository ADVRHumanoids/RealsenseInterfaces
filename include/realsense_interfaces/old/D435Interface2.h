...
#ifndef D435_INTERFACE_2_H
#define D435_INTERFACE_2_H
...
public:
    ...
    bool init(const geometry_msgs::Transform & cam_T_ref, const std::string& ref_frame);
    bool start(const rs2::context & ctx);
    bool update(const geometry_msgs::Transform* cam_T_ref = nullptr);
    
    virtual ~D435Interface() {};
    
    std::string getCameraName() const;
    std::string getSerial() const;
    geometry_msgs::Transform getCamTRef() const;
